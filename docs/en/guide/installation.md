...
| --- | --- |
| <ul><li>Open Edge browser.</li><li>Click the menu button in the upper right corner (three horizontal dots).</li><li>Go to "Extensions -> Manage Extensions".</li><li>Find the "Jego" extension and make sure it is enabled.</li><li>Click the Extensions icon on the right side of the address bar to open the extensions list.</li><li>Click the pin icon on the right side of the "Jego" extension to pin it to the toolbar.</li><li>This way, you can see the small "Jego" icon on the far right of the browser address bar for convenient daily use.</li></ul> | <ul><li>Open Chrome browser.</li><li>Click the menu button in the upper right corner (three vertical dots).</li><li>Go to "Extensions -> Manage Extensions".</li><li>Find the "Jego" extension and make sure it is enabled.</li><li>Click the Extensions icon on the right side of the address bar to open the extensions list.</li><li>Make sure the pin icon on the right side of the "Jego" extension is selected in blue.</li><li>This way, you can see the small "Jego" icon on the far right of the browser address bar for convenient daily use.</li></ul> |
